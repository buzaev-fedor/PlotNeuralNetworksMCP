...
def flat_begin() -> str:
    return (
        ...
        r"    arrow/.style={->, thick, color=clrborder, line width=0.7pt,"
        r" shorten >=1.5pt, shorten <=1.5pt}," "\n"
        r"    skiparrow/.style={->, thick, color=clrresidual, line width=0.8pt,"
        r" rounded corners=4pt, shorten >=1.5pt}," "\n"
