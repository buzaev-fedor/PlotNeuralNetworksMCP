...
\node[block, fill=clrembed!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.8cm of n_1] (n_2) {Input (x, y, t)};
...
\node[block, fill=clrresidual!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.8cm of n_7] (n_8) {$\mathcal{L}_{data}$ = MSE(pred, data)};
...
\draw[arrow] (n_10.north) -- node[right, yshift=-2pt, font=\sffamily\scriptsize, text=clrtext] {Output} ([yshift=0.6cm]n_10.north);
