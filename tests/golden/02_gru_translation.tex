...
\node[above=0.6cm of add_14, inner sep=0, minimum height=0] (n_15_rule) {};
...
\node[block, fill=clrresidual!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.4cm of n_15] (n_16) {Context Vector};
...
\draw[skiparrow] (res_entry_3.east) -- ++(2.3,0) |- (add_8.east);
\draw[arrow] (n_7.north) -- (res_entry_3.south);
...
\draw[skiparrow] (res_entry_9.east) -- ++(2.3,0) |- (add_14.east);
\draw[arrow] (n_13.north) -- (res_entry_9.south);
\draw[arrow] (n_15.north) -- (n_15.south);
\draw[arrow] (n_16.north) -- (n_16.south);
\draw[arrow] (n_17.north) -- (n_17.south);
...
\draw[skiparrow] (res_entry_18.east) -- ++(2.3,0) |- (add_23.east);
\draw[arrow] (n_22.north) -- (res_entry_18.south);
...
\draw[skiparrow] (res_entry_24.east) -- ++(2.3,0) |- (add_29.east);
\draw[arrow] (n_28.north) -- (res_entry_24.south);
\draw[arrow] (n_30.north) -- (n_30.south);
...
\draw[arrow] (n_31.north) -- node[right, yshift=-2pt, font=\sffamily\scriptsize, text=clrtext] {Output} ++ (0,0.5);
\node[draw=clrgroup_frame, rounded corners=6pt, dashed, line width=0.8pt, fill=clrgroup_fill, fill opacity=0.4, inner sep=0.35cm, fit=(n_4) (n_5) (n_6) (n_7) (n_10) (n_11) (n_12) (n_13)] (g_0) {};
\node[draw=clrgroup_frame, rounded corners=6pt, dashed, line width=0.8pt, fill=clrgroup_fill, fill opacity=0.4, inner sep=0.35cm, fit=(n_19) (n_20) (n_21) (n_22) (n_25) (n_26) (n_27) (n_28)] (g_1) {};
