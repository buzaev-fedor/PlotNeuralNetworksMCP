...
\node[above=0.6cm of add_13, inner sep=0, minimum height=0] (n_14_rule) {};
...
\node[above=0.6cm of add_24, inner sep=0, minimum height=0] (n_25_rule) {};
...
\node[inner sep=0, minimum size=0, above=0.4cm of n_25] (res_entry_26) {};
...
\node[above=0.6cm of add_35, inner sep=0, minimum height=0] (n_36_rule) {};
...
\node[inner sep=0, minimum size=0, above=0.4cm of n_36] (res_entry_37) {};
...
\draw[arrow] (n_2.north) -- (n_1.south);
...
\draw[skiparrow] (res_entry_4.east) -- ++(2.3,0) |- (add_8.east);
\draw[arrow] (n_7.north) -- (res_entry_4.south);
...
\draw[skiparrow] (res_entry_9.east) -- ++(2.3,0) |- (add_13.east);
\draw[arrow] (n_12.north) -- (res_entry_9.south);
...
\draw[skiparrow] (res_entry_15.east) -- ++(2.3,0) |- (add_19.east);
\draw[arrow] (n_18.north) -- (res_entry_15.south);
...
\draw[skiparrow] (res_entry_20.east) -- ++(2.3,0) |- (add_24.east);
\draw[arrow] (n_23.north) -- (res_entry_20.south);
...
\draw[skiparrow] (res_entry_26.east) -- ++(2.3,0) |- (add_30.east);
\draw[arrow] (n_29.north) -- (res_entry_26.south);
...
\draw[skiparrow] (res_entry_31.east) -- ++(2.3,0) |- (add_35.east);
\draw[arrow] (n_34.north) -- (res_entry_31.south);
\draw[arrow] (n_36.north) -- (n_36.south);
...
\draw[skiparrow] (res_entry_37.east) -- ++(2.3,0) |- (add_41.east);
\draw[arrow] (n_40.north) -- (res_entry_37.south);
...
\draw[skiparrow] (res_entry_42.east) -- ++(2.3,0) |- (add_46.east);
\draw[arrow] (n_45.north) -- (res_entry_42.south);
\draw[arrow] (n_47.north) -- (n_47.south);
\draw[arrow] (n_48.north) -- (n_48.south);
\draw[arrow] (n_1.south) ++ (0,-0.5) -- node[right, yshift=-2pt, font=\sffamily\scriptsize, text=clrtext] {Input} (n_1.south);
\draw[arrow] (n_48.north) -- node[right, yshift=-2pt, font=\sffamily\scriptsize, text=clrtext] {Output} ++ (0,0.5);
\node[draw=clrgroup_frame, rounded corners=6pt, dashed, line width=0.8pt, fill=clrgroup_fill, fill opacity=0.4, inner sep=0.35cm, fit=(n_5) (n_6) (n_7) (n_10) (n_11) (n_12)] (g_0) {};
\node[right=12pt of g_0.east, anchor=west, font=\sffamily\Large\bfseries, text=clrborder] (g_0_badge) {$\times3$};
\node[draw=clrgroup_frame, rounded corners=6pt, dashed, line width=0.8pt, fill=clrgroup_fill, fill opacity=0.4, inner sep=0.35cm, fit=(n_16) (n_17) (n_18) (n_21) (n_22) (n_23)] (g_1) {};
\node[right=12pt of g_1.east, anchor=west, font=\sffamily\Large\bfseries, text=clrborder] (g_1_badge) {$\times4$};
\node[draw=clrgroup_frame, rounded corners=6pt, dashed, line width=0.8pt, fill=clrgroup_fill, fill opacity=0.4, inner sep=0.35cm, fit=(n_27) (n_28) (n_29) (n_32) (n_33) (n_34)] (g_2) {};
\node[right=12pt of g_2.east, anchor=west, font=\sffamily\Large\bfseries, text=clrborder] (g_2_badge) {$\times6$};
\node[draw=clrgroup_frame, rounded corners=6pt, dashed, line width=0.8pt, fill=clrgroup_fill, fill opacity=0.4, inner sep=0.35cm, fit=(n_38) (n_39) (n_40) (n_43) (n_44) (n_45)] (g_3) {};
