...
\node[block, fill=clrembed!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.8cm of n_1] (n_2) {Input u(x) at sensors};
...
\node[block, fill=clrattention_alt!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.8cm of n_6] (n_7) {Eval point y};
...
\node[inner sep=0, minimum height=0, above=1.0cm of n_10] (n_11_rule) {};
...
\node[block, fill=clrresidual!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.8cm of n_11] (n_12) {$\sum b_k \cdot t_k + b_0$};
