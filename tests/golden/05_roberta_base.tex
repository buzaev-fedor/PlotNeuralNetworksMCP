...
\node[block, fill=clrembed!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext] (n_1) at (0,0) {BPE Embedding (50k)};
...
\node[below=0.6cm of current bounding box.south, subtitle, text width=14cm, align=center] {\textbf{RoBERTa-base -- Dynamic Masking}};
\end{tikzpicture}
\end{document}
