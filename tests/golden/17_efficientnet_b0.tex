...
\draw[skiparrow] (res_entry_2.east) -- ++(2.3,0) |- (add_7.east);
\draw[arrow] (n_6.north) -- (res_entry_2.south);
...
\draw[skiparrow] (res_entry_8.east) -- ++(2.3,0) |- (add_13.east);
\draw[arrow] (n_12.north) -- (res_entry_8.south);
...
\draw[arrow] (n_17.north) -- node[right, yshift=-2pt, font=\sffamily\scriptsize, text=clrtext] {Output} ++ (0,0.5);
\node[draw=clrgroup_frame, rounded corners=6pt, dashed, line width=0.8pt, fill=clrgroup_fill, fill opacity=0.4, inner sep=0.35cm, fit=(n_3) (n_4) (n_5) (n_6) (n_9) (n_10) (n_11) (n_12)] (g_0) {};
