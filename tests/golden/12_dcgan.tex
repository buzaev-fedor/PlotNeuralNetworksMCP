...
\node[above=4pt of n_1_rule, font=\sffamily\normalsize\bfseries, text=clrborder] (n_1) {Generator};
\node[block, fill=clrresidual!85, minimum width=2.0cm, minimum height=1.0cm, text=clrtext, above=0.8cm of n_1] (n_2) {Noise z (100d)};
\node[block, fill=clrembed!85, minimum width=4.0cm, minimum height=1.0cm, text=clrtext, above=0.4cm of n_2] (n_3) {TransConv 4x4 (512) + BN + ReLU};
\node[block, fill=clrembed!85, minimum width=4.0cm, minimum height=1.0cm, text=clrtext, above=0.4cm of n_3] (n_4) {TransConv 4x4 (256) + BN + ReLU};
\node[block, fill=clrembed!85, minimum width=4.0cm, minimum height=1.0cm, text=clrtext, above=0.4cm of n_4] (n_5) {TransConv 4x4 (128) + BN + ReLU};
\node[block, fill=clrembed!85, minimum width=4.0cm, minimum height=0.85cm, text=clrtext, above=0.4cm of n_5] (n_6) {Generated Image 64x64};
...
\node[above=4pt of n_7_rule, font=\sffamily\normalsize\bfseries, text=clrborder] (n_7) {Discriminator};
\node[block, fill=clrphysics!85, minimum width=4.0cm, minimum height=1.0cm, text=clrtext, above=0.8cm of n_7] (n_8) {Conv 4x4 (64) + LeakyReLU};
\node[block, fill=clrphysics!85, minimum width=4.0cm, minimum height=1.0cm, text=clrtext, above=0.4cm of n_8] (n_9) {Conv 4x4 (128) + BN + LeakyReLU};
\node[block, fill=clrphysics!85, minimum width=4.0cm, minimum height=1.0cm, text=clrtext, above=0.4cm of n_9] (n_10) {Conv 4x4 (256) + BN + LeakyReLU};
\node[block, fill=clroutput!85, minimum width=2.0cm, minimum height=1.2cm, text=clrtext, above=0.4cm of n_10] (n_11) {Real / Fake};
...
\draw[arrow] (n_11.north) -- node[right, yshift=-2pt, font=\sffamily\scriptsize, text=clrtext] {Output} ([yshift=0.6cm]n_11.north);
...
\node[draw=clrgroup_frame!60, rounded corners=8pt, densely dashed, line width=0.6pt, fill=clrgroup_fill, fill opacity=0.35, inner ysep=0.55cm, inner xsep=0.7cm, fit=(n_8) (n_9) (n_10)] (g_1) {};
\node[below=0.6cm of current bounding box.south, subtitle, text width=14cm, align=center] {\textbf{DCGAN}};
\end{tikzpicture}
\end{document}
