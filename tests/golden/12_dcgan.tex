...
\node[block, fill=clrresidual!85, minimum width=2.0cm, minimum height=1.0cm, text=clrtext, above=0.4cm of n_1] (n_2) {Noise z (100d)};
...
\node[block, fill=clrphysics!85, minimum width=4.0cm, minimum height=1.0cm, text=clrtext, above=0.4cm of n_7] (n_8) {Conv 4x4 (64) + LeakyReLU};
...
\draw[arrow] (n_11.north) -- node[right, yshift=-2pt, font=\sffamily\scriptsize, text=clrtext] {Output} ++ (0,0.5);
