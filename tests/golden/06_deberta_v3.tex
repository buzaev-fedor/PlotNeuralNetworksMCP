...
\node[block, fill=clrembed!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext] (n_1) at (0,0) {Token Embedding (128k)};
\node[circle, draw=clrborder, fill=clrresidual!30, inner sep=2pt, font=\sffamily\scriptsize\bfseries, above=0.3cm of n_1] (n_2) {Relative Pos. Bias};
\node[inner sep=0, minimum size=0, above=0.4cm of n_2] (res_entry_3) {};
\node[block, fill=clrattention_alt!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.4cm of res_entry_3] (n_4) {Disentangled Attn};
...
\node[block, fill=clrattention_alt!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.4cm of res_entry_11] (n_12) {Disentangled Attn};
...
\node[block, fill=clrattention_alt!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.4cm of res_entry_19] (n_20) {Disentangled Attn};
...
\node[block, fill=clroutput!85, minimum width=3.8cm, minimum height=0.85cm, text=clrtext, above=0.4cm of n_26] (n_27) {Enhanced Mask Decoder};
\node[block, fill=clroutput!85, minimum width=3.8cm, minimum height=1.2cm, text=clrtext, above=0.4cm of n_27] (n_28) {Output};
\draw[arrow] (n_1.north) -- (n_2.south);
\draw[arrow] (res_entry_3.north) -- (n_4.south);
\draw[arrow] (n_4.north) -- (add_5.south);
\draw[skiparrow] (res_entry_3.east) -- ++(2.4,0) |- (add_5.east);
\draw[arrow] (add_5.north) -- (n_6.south);
\draw[arrow] (res_entry_7.north) -- (n_8.south);
\draw[arrow] (n_8.north) -- (add_9.south);
\draw[skiparrow] (res_entry_7.east) -- ++(2.4,0) |- (add_9.east);
...
\node[draw=clrgroup_frame!60, rounded corners=8pt, densely dashed, line width=0.6pt, fill=clrgroup_fill, fill opacity=0.35, inner ysep=0.55cm, inner xsep=0.7cm, fit=(n_4) (n_6) (n_8) (n_10) (n_12) (n_14) (n_16) (n_18) (n_20) (n_22) (n_24) (n_26)] (g_0) {};
\node[right=12pt of g_0.east, anchor=west, font=\sffamily\Large\bfseries, text=clrborder] (g_0_badge) {$\times12$};
\node[below=0.6cm of current bounding box.south, subtitle, text width=14cm, align=center] {\textbf{DeBERTa-v3 -- Disentangled Attention}};
\end{tikzpicture}
\end{document}
